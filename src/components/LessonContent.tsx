...
export default function LessonContent({selectedLesson}: LessonContentProps) {
  ...
  return (
    <article className="min-h-[420px] rounded-2xl border border-slate-800 bg-slate-900/80 p-5 sm:p-6">
      ...
      <div
        className="max-w-none space-y-5 leading-8 text-slate-200 [&_a]:text-amber-300 [&_a]:underline [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-slate-50 [&_h3]:mt-8 [&_h3]:text-xl [&_h3]:font-bold [&_h3]:text-slate-100 [&_hr]:my-8 [&_hr]:border-slate-800 [&_li]:ml-5 [&_li]:list-disc [&_p]:leading-8 [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:bg-slate-950 [&_pre]:p-4 [&_pre]:text-sm [&_table]:w-full [&_table]:border-collapse [&_td]:border [&_td]:border-slate-700 [&_td]:p-3 [&_th]:border [&_th]:border-slate-700 [&_th]:bg-slate-800 [&_th]:p-3"
